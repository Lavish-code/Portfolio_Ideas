...
export default function About() {
  return (
    <section id="about" className="py-20 px-4 md:px-6 lg:px-8 scroll-mt-20">
            ...
            <Card className="hover:shadow-lg transition-all duration-300">
              <CardContent className="p-6">
                <p className="text-lg mb-4">
                  I’m a full-stack developer with a strong focus on backend development. I build modern, scalable web applications using technologies like Java (Spring Boot), Node.js, and MongoDB, while also ensuring seamless user experiences through clean frontend design.
                </p>
                <p className="text-lg mb-4">
